...
.ibox{{background:rgba(79,142,247,.05);border:1px solid rgba(79,142,247,.12);
  border-radius:14px;padding:16px 20px;margin:24px auto;max-width:820px;
...
<div class="hh">
  ...
  <div class="hsub">Upload your Excel files · Generate 3 interactive dashboards instantly</div>
</div>
<div class="dprow">
